...
namespace rFactor2plugin
{
    ...
    namespace rFactor2Data
    {
        ...
        public struct rF2Vec3
        {
            ...
            public static implicit operator double[](rF2Vec3 vec3)
            {
                return new double[] { vec3.x, vec3.y, vec3.y };
            }

            public static implicit operator float[](rF2Vec3 vec3)
            {
        ...
        public struct rF2VehicleTelemetry
        {
            ...
            public float Heave
            {
                get { return (float)mLocalAccel.y / 9.81f; }
            }

            public float Surge
            {
                get { return (float)mLocalAccel.z / 9.81f; }
            }

            public float Sway
            {
                get { return (float)mLocalAccel.x / 9.81f; }
            }

            /// <summary>
            /// Car speed, km per hour
            /// </summary>
            public float Speed
            {
                get { return (float)Math.Abs(mLocalVel.z * 3.6f); }
            }
        }
        ...
        public struct rF2Telemetry
        {
            ...
            {
                return Marshal.SizeOf(typeof(rF2Telemetry));
            }
        }
