...
namespace HerboldRacing
{
	...
	{
		public readonly Dictionary<string, IRacingSdkDatum> TelemetryDataProperties = new Dictionary<string, IRacingSdkDatum>();
		public string SessionInfoYaml { get; private set; } = string.Empty;
		public IRacingSdkSessionInfo SessionInfo { get; private set; } = new IRacingSdkSessionInfo();
		...
		public void Reset()
		{
			...
			SessionInfo = new IRacingSdkSessionInfo();
