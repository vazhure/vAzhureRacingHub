...
void setup() {
  ...
  // i2c_slave_enable(I2C1, I2C_FAST_MODE | I2C_SLAVE_GENERAL_CALL, 400000);
  // // attach  receive handler
  // i2c_slave_attach_recv_handler(I2C1, &rxMsg, receiveEvent);
  // // attach transmit handler
  // i2c_slave_attach_transmit_handler(I2C1, &txMsg, requestEvent);
  // // set address #1
  // i2c_slave_set_own_address(I2C1, SLAVE_ADDR);
