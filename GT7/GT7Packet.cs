...
namespace GT7Telemetry
{
    ...
    public struct GT7PacketA
    {
        ...
        public byte[] IV;                      // 0x40 - 0x43 (для nonce)
        ...
        public int BestLapTime;                // 0x78 (мс, -1 если не задано)
        ...
        public byte Gears;                     // 0x92 (нибблы: текущая/рекомендуемая)
        public byte Throttle;                  // 0x93 (0-255)
        public byte Brake;                     // 0x94 (0-255)
        ...
        // Unknown floats x8 = 32 байта (0xD6 - 0xF5)
        ...
        public bool IsRevLimiterAlert => (Flags & 0x1) != 0;
        public bool IsInGear => (Flags & 0x2) != 0;
    }
}